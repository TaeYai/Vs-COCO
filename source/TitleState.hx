...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		var titleBg:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('bg'));
		...
		gfDance = new FlxSprite(700, 0);
		gfDance.frames = Paths.getSparrowAtlas('cocotitle');
		...
		credTextShit = new Alphabet(0, 0, "CocoTheMunchkin\nKlogmooz\nLiterallyNoOne\nPunkinMike\nShibecicle", true);
	...
	override function beatHit()
	{
		...
		{
			case 1:
				createCoolText(['CocoTheMunchkin', 'Klogmooz', 'LiterallyNoOne', 'PunkinMike', 'Shibecicle']);
			...
			// credTextShit.screenCenter();
			case 5:
					createCoolText(['Approved', 'by']);
			case 7:
					addMoreText('jabibi among us');
					ngSpr.visible = true;
			// credTextShit.text += '\nNewgrounds';
			case 8:
				deleteCoolText();
