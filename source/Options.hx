...
class NoteCamOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.camnoteoption = !FlxG.save.data.camnoteoption;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.camnoteoption ? "Cam Movement Off" : "Cam Movement On";
	}
}
...
class SplashOption extends Option
{
	...
	public override function press():Bool
	{
		FlxG.save.data.splashoption = !FlxG.save.data.splashoption;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.splashoption ? "Notesplashes On" : "Notesplashes Off";
	}
}
